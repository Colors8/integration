...
add_action('init', 'create_kit_post_type');
...
function create_kit_post_type() {


	$labels = array(
		'name'                =>  'create_kit' ,
		'singular_name'       => 'create_kit',
		'menu_name'           => __( 'create_kit', 'text_domain' ),
		'name_admin_bar'      => __( 'Post Type', 'text_domain' ),
		'parent_item_colon'   => __( 'Parent Item:', 'text_domain' ),
		'all_items'           => __( 'Tout les items', 'text_domain' ),
		'add_new_item'        => __( 'Add New Item', 'text_domain' ),
	...
	$args = array(
		'label'               => __( 'create_kit', 'text_domain' ),
		'description'         => __( 'Post Type Description', 'text_domain' ),
		'labels'              => $labels,
		'supports'            => array('thumbnail','title','editor','author','page-attributes','custom-fields' ),
		'taxonomies'          => array( 'category', 'post_tag' ),
